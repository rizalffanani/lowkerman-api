...
const TABLE = 'location_cities';
const ID_COLUMN = 'id_city';

const MESSAGES = {
    DATABASE_ERROR: 'Database error',
    REQUIRED_FIELDS: 'All fields are required',
    DATA_EXISTS: 'City already exists',
    DATA_NOT_FOUND: 'City not found',
    DATA_ADDED: 'City added',
    DATA_UPDATED: 'City updated',
    DATA_DELETED: 'City deleted',
